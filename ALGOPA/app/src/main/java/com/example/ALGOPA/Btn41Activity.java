...
public class Btn41Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn41);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit35);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn35);
