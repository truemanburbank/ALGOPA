...
public class Btn30Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn30);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit24);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn24);
