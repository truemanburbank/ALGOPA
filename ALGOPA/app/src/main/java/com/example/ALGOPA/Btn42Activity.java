...
public class Btn42Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn42);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit36);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn36);
