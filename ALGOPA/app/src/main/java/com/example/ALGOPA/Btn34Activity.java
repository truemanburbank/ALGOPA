...
public class Btn34Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn34);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit28);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn28);
