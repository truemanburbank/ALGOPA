...
public class Btn22Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn22);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit16);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn16);
