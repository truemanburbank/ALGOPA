...
public class Btn37Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn37);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit31);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn31);
