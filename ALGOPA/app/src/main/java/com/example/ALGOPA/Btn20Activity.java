...
public class Btn20Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit14);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn14);
