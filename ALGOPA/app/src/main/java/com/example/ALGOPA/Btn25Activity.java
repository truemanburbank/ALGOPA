...
public class Btn25Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn25);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit19);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn19);
