...
public class Btn14Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn14);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit8);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn8);
