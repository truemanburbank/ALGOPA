...
public class Btn15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn15);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit9);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn9);
