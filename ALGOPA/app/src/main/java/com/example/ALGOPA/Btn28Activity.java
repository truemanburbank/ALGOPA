...
public class Btn28Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn28);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit22);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn22);
