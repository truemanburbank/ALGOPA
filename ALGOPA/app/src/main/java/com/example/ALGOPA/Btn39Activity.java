...
public class Btn39Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn39);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit33);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn33);
