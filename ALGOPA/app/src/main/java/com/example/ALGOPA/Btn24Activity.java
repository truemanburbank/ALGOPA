...
public class Btn24Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn24);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit18);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn18);
