...
public class Btn13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit7);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn7);
