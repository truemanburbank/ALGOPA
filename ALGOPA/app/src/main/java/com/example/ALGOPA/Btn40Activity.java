...
public class Btn40Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn40);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit34);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn34);
