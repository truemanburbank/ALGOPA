...
public class Btn29Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn29);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit23);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn23);
