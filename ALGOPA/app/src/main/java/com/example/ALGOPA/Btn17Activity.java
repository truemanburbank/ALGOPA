...
public class Btn17Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn17);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit11);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn11);
