...
public class Btn33Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn33);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit27);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn27);
