...
public class Btn19Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn19);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit13);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn13);
