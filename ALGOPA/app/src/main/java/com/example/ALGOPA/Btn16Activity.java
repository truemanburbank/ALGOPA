...
public class Btn16Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit10);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn10);
