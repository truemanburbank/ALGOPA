...
public class Btn23Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn23);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit17);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn17);
