...
public class Btn38Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn38);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit32);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn32);
