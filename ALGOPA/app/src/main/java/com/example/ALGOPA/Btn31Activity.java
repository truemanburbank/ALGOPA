...
public class Btn31Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn31);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit25);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn25);
