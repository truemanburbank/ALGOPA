...
public class Btn9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit3);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn3);
