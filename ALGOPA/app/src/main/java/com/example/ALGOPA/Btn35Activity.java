...
public class Btn35Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn35);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit29);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn29);
