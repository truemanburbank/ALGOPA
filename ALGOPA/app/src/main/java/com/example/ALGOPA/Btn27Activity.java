...
public class Btn27Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn27);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit21);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn21);
