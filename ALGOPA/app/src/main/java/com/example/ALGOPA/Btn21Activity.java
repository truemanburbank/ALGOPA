...
public class Btn21Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn21);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit15);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn15);
