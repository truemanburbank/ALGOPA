...
public class Btn36Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn36);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit30);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn30);
