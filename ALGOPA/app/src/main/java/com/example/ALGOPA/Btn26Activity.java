...
public class Btn26Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn26);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit20);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn20);
