...
public class Btn32Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn32);
        ...
        Button imageButton = (Button)findViewById(R.id.btnexit26);
        ...
        });Button imageButton1 = (Button)findViewById(R.id.addbtn26);
